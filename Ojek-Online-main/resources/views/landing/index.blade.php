...
@section('title', 'OMK OJOL - Ojek Mitra Mahasiswa')

@section('content')

{{-- =========================================================
| HERO DENGAN GRADIENT BACKGROUND (TANPA FOTO)
========================================================= --}}
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="relative bg-gray-800/70 backdrop-blur
                ...
                <div class="absolute inset-x-0 top-0 h-1 bg-blue-600 rounded-t-2xl"></div>
                <div class="text-4xl mb-5 text-blue-400 group-hover:scale-110 transition">🛵</div>
            ...
            <div class="relative bg-gray-800/70 backdrop-blur
                ...
                <div class="absolute inset-x-0 top-0 h-1 bg-green-600 rounded-t-2xl"></div>
                <div class="text-4xl mb-5 text-green-400 group-hover:scale-110 transition">📦</div>
                <h3 class="text-xl font-semibold mb-3 text-white">
                    Kurir & Pengiriman
                </h3>
                <p class="text-gray-400 text-sm">
            ...
            <div class="relative bg-gray-800/70 backdrop-blur
                ...
                <div class="absolute inset-x-0 top-0 h-1 bg-purple-600 rounded-t-2xl"></div>
                <div class="text-4xl mb-5 text-purple-400 group-hover:scale-110 transition">🍔</div>
                <h3 class="text-xl font-semibold mb-3 text-white">
                    Pesan Makanan
                </h3>
                <p class="text-gray-400 text-sm">
